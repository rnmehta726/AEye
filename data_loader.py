...
def get_loader(transform,
    ...
    if mode == 'train':
        ...
        img_folder = 'cocoapi/images/val2017/'
        annotations_file = 'cocoapi/annotations/captions_val2017.json'
    elif mode == 'val':
        img_folder = 'cocoapi/images/train2017/'
        annotations_file = 'cocoapi/annotations/captions_train2017.json'
    else:
        raise KeyError('mode not known. Select [train/test/val]')
...
class CoCoDataset(data.Dataset):
    ...
    def __init__(self, transform, mode, batch_size, vocab_threshold, vocab_file, start_word,
        ...
        if self.mode == 'train':
            ...
            all_tokens = [nltk.tokenize.word_tokenize(str(self.coco.anns[self.ids[index]]['caption']).lower()) for index in
                          tqdm(np.arange(len(self.ids)))]
